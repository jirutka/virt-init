...
This project is no longer actively maintained, as I no longer use it myself.
I will only address reported bugs.
If you are using Proxmox, consider switching to https://github.com/jirutka/prox-init[prox-init] instead.
On Alpine Linux, you can also switch to https://gitlab.alpinelinux.org/alpine/cloud/tiny-cloud/[tiny-cloud].
